...
setup(
    ...
    name='shairport-sync-metadata-reader',  # Required
    ...
    description='A shairport-sync metadata reader',  # Required
    ...
    url='https://github.com/idcrook/shairport-sync-metadata-reader-python',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='David Crook',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='idcrook@users.noreply.github.com',  # Optional
